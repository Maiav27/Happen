...
const Page15 = () => {
    ...
    const [pag15, setPag15] = useState(FormStore.IE[4] ? FormStore.IE[4] : '')
  
    function salvarRadio(){
      FormStore.IE[4]  = pag15;
 ...
 return(
    <div id="question-15">
            ...
            <div id="home2" class="button"><Link style={{ textDecoration : 'none', color : 'black'  }} onClick={salvarRadio} to ={'/Page16'}>Próximo</Link></div>
            <div id="home" class="button"><Link style={{ textDecoration : 'none', color : 'black'  }} onClick={salvarRadio} to ={'/Page14'}  >Voltar</Link></div>
