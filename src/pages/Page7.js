 ...
 return(
    ...
    <h3>Sempre que alguém me pede uma ajuda e não estou disponível,
       ...
       <input id="question-2-answer-a" type="radio" name="favelang" checked={Pag7 === 1}  onChange={()=>setPag7(1)}/> Concordo totalmente<br/>
            ...
            <div id="home2" class="button"><Link style={{ textDecoration : 'none', color : 'black'  }} onClick={salvarRadio} to ={'/Page8'}>Próximo</Link></div>
              <div id="home" class="button"><Link style={{ textDecoration : 'none', color : 'black'  }} onClick={salvarRadio} to ={'/Page6'}  >Voltar</Link></div>
